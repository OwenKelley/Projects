...
////////////////////////////////////////////////////////////////
/*
  hdrive - takes current trip value and modifies all private variables accordingly

  precondition - takes in current trip value
  postcondition - changes private variables
*/
   void hdrive(double);
////////////////////////////////////////////////////////////////
/*
  hybridType (parameterized) constructor - refer to autotype constructor
*/
    hybridType(double, double, double, double, double, double);
////////////////////////////////////////////////////////////////
//  hybridType default constructor - refer to autotype constructor
    hybridType();
